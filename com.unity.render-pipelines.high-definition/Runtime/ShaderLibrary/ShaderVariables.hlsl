...
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/Camera/HDCamera.cs.hlsl"
    ...
    #define _WorldSpaceCameraPos            _ViewConstantsXR[unity_StereoEyeIndex].worldSpaceCameraPos
    #define _WorldSpaceCameraPosViewOffset  _ViewConstantsXR[unity_StereoEyeIndex].worldSpaceCameraPosViewOffset
    #define _PrevCamPosRWS                  _ViewConstantsXR[unity_StereoEyeIndex].prevWorldSpaceCameraPos
#endif
...
CBUFFER_START(UnityPerPassStereo)
    StructuredBuffer<ViewConstants> _ViewConstantsXR;
CBUFFER_END
